...
const NotFound: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background-dark text-white p-6 relative overflow-hidden transition-colors duration-300">
            {/* Elementos decorativos de fondo */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-[100px] pointer-events-none"></div>
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gray-400/5 rounded-full blur-[100px] pointer-events-none"></div>

            <div className="max-w-md w-full text-center space-y-8 relative z-10">
                <div className="text-primary flex justify-center transform -rotate-12 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="pt-8">
                    <Link
                        to={getRedirectPath()}
                        className="inline-flex justify-center items-center px-8 py-3 rounded-lg shadow-lg shadow-primary/20 text-lg font-bold text-black bg-primary hover:bg-emerald-600 transition-all duration-300 transform hover:-translate-y-0.5 gap-2"
                    >
